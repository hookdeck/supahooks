    ...
    <html lang="en">
      <body className={inter.className}>
        <div className="flex min-h-screen flex-col items-center p-24 pt-4">
          <div className="z-10 w-full max-w-5xl items-start justify-between lg:flex mt-4">
            <div className="flex flex-col justify-start items-start gap-2">
              <h1 className="flex text-xl dark:from-inherit lg:static lg:w-auto">
                <Link href="/">SupaHooks</Link>
              </h1>
              <h2 className="font-mono">Hookdeck Outbound Webhooks Demo</h2>
            </div>
